 ...
 */
public class APayrollSearch extends JFrame implements ActionListener{
...
img.add(b2);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        {
            frame.setVisible(false);
            new APayrollReport(startDateString, endDateString);
        }
       
    }
    public static void main (String[] args)
    {
        new APayrollSearch().setVisible(true);
    }
}
